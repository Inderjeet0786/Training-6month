  ...
  <section id="about" className="about section">
    <div className="container">
      <div className="row gy-4">
        ...
        >
          <img src="/assets/assets/img/about.jpg" className="img-fluid" alt="" />
        </div>
        <div
        ...
        >
          <h3>Voluptatem dignissimos provident quasi corporis</h3>
           <button onClick={incfun}>++++</button><h1>{count}</h1><button onClick={decFun}>---</button>
      ...
      <div className="row">
        ...
        >
          <div className="course-item">
            <img
              src="/assets/assets/img/course-1.jpg"
              className="img-fluid"
              alt="..."
            />
            <div className="course-content">
              ...
              <div className="trainer d-flex justify-content-between align-items-center">
                <div className="trainer-profile d-flex align-items-center">
                  <img
                    src="/assets/assets/img/trainers/trainer-1-2.jpg"
                    className="img-fluid"
                    alt=""
                  />
        ...
        >
          <div className="course-item">
            <img
              src="/assets/assets/img/course-2.jpg"
              className="img-fluid"
              alt="..."
            />
            <div className="course-content">
              ...
              <div className="trainer d-flex justify-content-between align-items-center">
                <div className="trainer-profile d-flex align-items-center">
                  <img
                    src="/assets/assets/img/trainers/trainer-2-2.jpg"
                    className="img-fluid"
                    alt=""
                  />
                  <a href="" className="trainer-link">
        ...
        >
          <div className="course-item">
            <img
              src="/assets/assets/img/course-3.jpg"
              className="img-fluid"
              alt="..."
            />
            <div className="course-content">
              ...
              <div className="trainer d-flex justify-content-between align-items-center">
                <div className="trainer-profile d-flex align-items-center">
                  <img
                    src="/assets/assets/img/trainers/trainer-3-2.jpg"
                    className="img-fluid"
                    alt=""
                  />
                  <a href="" className="trainer-link">
      ...
      <div className="row">
        ...
        >
          <div className="member">
            <img
              src="/assets/assets/img/trainers/trainer-1.jpg"
              className="img-fluid"
              alt=""
            />
        ...
        >
          <div className="member">
            <img
              src="/assets/assets/img/trainers/trainer-2.jpg"
              className="img-fluid"
              alt=""
            />
            <div className="member-content">
        ...
        >
          <div className="member">
            <img
              src="/assets/assets/img/trainers/trainer-3.jpg"
              className="img-fluid"
              alt=""
            />
            <div className="member-content">
