export default function Third(probs) {
    ...
    let passedstudents = students.filter((student) => student.marks>33)
    ...
    return (
        <>
            ...
            <h3 style={{ margin: '30px auto 0 auto' }}>Fail Students Data:</h3>
            ...
            <h3 style={{marginTop:'70px'}}>Passed Students data:</h3>
