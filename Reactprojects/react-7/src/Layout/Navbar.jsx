                        ...
                        <div className="notif-center">
                          <a href="#">
                            <div className="notif-img">
                              <img src="/src/assets/assets/img/jm_denis.jpg" alt="Img Profile" />
                            </div>
                          ...
                          <a href="#">
                            <div className="notif-img">
                              <img src="/src/assets/assets/img/chadengle.jpg" alt="Img Profile" />
                            </div>
                            <div className="notif-content">
                          ...
                          <a href="#">
                            <div className="notif-img">
                              <img src="/src/assets/assets/img/mlane.jpg" alt="Img Profile" />
                            </div>
                            <div className="notif-content">
                          ...
                          <a href="#">
                            <div className="notif-img">
                              <img src="/src/assets/assets/img/talha.jpg" alt="Img Profile" />
                            </div>
                            <div className="notif-content">
                    ...
                    <li>
                      <div className="notif-scroll scrollbar-outer">
                        <div className="notif-center">
                          ...
                          <a href="#">
                            <div className="notif-img">
                              <img src="/src/assets/assets/img/profile2.jpg" alt="Img Profile" />
                            </div>
                            <div className="notif-content">
                              <span className="block">
                ...
                <li className="nav-item topbar-user dropdown hidden-caret">
                  <a className="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
                    <div className="avatar-sm">
                      <img src="/src/assets/assets/img/profile.jpg" alt="..." className="avatar-img rounded-circle" />
                    </div>
                      ...
                      <li>
                        <div className="user-box">
                          <div className="avatar-lg">
                            <img src="/src/assets/assets/img/profile.jpg" alt="image profile" className="avatar-img rounded" />
                          </div>
