            ...
            <div className="row">
              ...
              <div className="col-md-12">
                <div className="card">
                  ...
                  <div className="card-body">
                    <p className="demo">
                      <button type="button" className="btn btn-icon btn-round btn-black">
                        <i className="fa fa-align-left" />
                      </button>

                      <button type="button" className="btn btn-icon btn-round btn-primary">
                        <i className="fab fa-twitter" />
                      </button>

                      <button type="button" className="btn btn-icon btn-round btn-secondary">
                        <i className="fa fa-bookmark" />
                      </button>

                      <button type="button" className="btn btn-icon btn-round btn-info">
                        <i className="fa fa-info" />
                      </button>

                      <button type="button" className="btn btn-icon btn-round btn-success">
                        <i className="fa fa-check" />
                      </button>

                      <button type="button" className="btn btn-icon btn-round btn-warning">
                        <i className="fa fa-exclamation-circle" />
                      </button>

                      <button type="button" className="btn btn-icon btn-round btn-danger">
                        <i className="fa fa-heart" />
                      </button>
              ...
              <div className="col-md-12">
                <div className="card">
                  ...
                  <div className="card-body">
                    <p className="demo">
                      <button className="btn btn-black" disabled={true}>
                        Default
                      </button>
                      ...
                      <button className="btn btn-link" disabled={true}>Link</button>
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="card-body">
                    <div className="demo">
                      ...
                      <div className="btn-group dropstart">
                        <button type="button" className="btn btn-black btn-border dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          DropLeft
                        </button>
                        <ul className="dropdown-menu" role="menu">
                          <li>
