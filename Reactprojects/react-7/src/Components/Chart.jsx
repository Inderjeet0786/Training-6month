...
export default function Chart(){
  ...
  <div className="page-inner">
    ...
    <div className="page-category">
      ...
      <Link to="http://www.chartjs.org/" target="_blank">
        full documentation
      </Link>
      .
    </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <div className="card-sub">
              Sometimes you need Link very complex legend. In these cases, it makes
              sense to generate an HTML legend. Charts provide Link
