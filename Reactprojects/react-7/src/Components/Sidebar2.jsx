              ...
              <div className="col-12 col-sm-6 col-md-6 col-xl-3">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="progress progress-sm">
                      <div className="progress-bar bg-danger w-50" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" />
                    </div>
                    <div className="d-flex justify-content-between mt-2">
                      <p className="text-muted mb-0">Change</p>
              ...
              <div className="col-12 col-sm-6 col-md-6 col-xl-3">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="progress progress-sm">
                      <div className="progress-bar bg-secondary w-25" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" />
                    </div>
                    <div className="d-flex justify-content-between mt-2">
                      <p className="text-muted mb-0">Change</p>
                      <p className="text-muted mb-0">25%</p>
						...
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body pb-0">
									<div class="d-flex">
										<div class="avatar">
											<img src="/src/assets/assets/img/logoproduct.svg" alt="..." class="avatar-img rounded-circle">
										</div>
									...
									<div class="d-flex">
										<div class="avatar">
											<img src="/src/assets/assets/img/logoproduct3.svg" alt="..." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ms-2">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										<div class="item-list">
											<div class="avatar">
												<img src="/src/assets/assets/img/jm_denis.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
										...
										<div class="item-list">
											<div class="avatar">
												<img src="/src/assets/assets/img/chadengle.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ms-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="/src/assets/assets/img/talha.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ms-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="/src/assets/assets/img/mlane.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ms-3">
                  ...
                  <div className="card-body pb-0">
                    <div className="d-flex">
                      <div className="avatar">
                        <img src="/src/assets/assets/img/logoproduct.svg" alt="..." className="avatar-img rounded-circle" />
                      </div>
                    ...
                    <div className="d-flex">
                      <div className="avatar">
                        <img src="/src/assets/assets/img/logoproduct3.svg" alt="..." className="avatar-img rounded-circle" />
                      </div>
                      <div className="flex-1 pt-1 ms-2">
                        <h6 className="fw-bold mb-1">Ready Pro</h6>
                        <small className="text-muted">Bootstrap 5 Admin Dashboard</small>
                      </div>
                      <div className="d-flex ms-auto align-items-center">
                          ...
                          <table className="table">
                            <tbody>
                              <tr>
                                <td>
                                  <div className="flag">
                                    <img src="/src/assets/assets/img/flags/id.png" alt="indonesia" />
                                  </div>
                                </td>
                                <td>Indonesia</td>
                              ...
                              <tr>
                                <td>
                                  <div className="flag">
                                    <img src="/src/assets/assets/img/flags/us.png" alt="united states" />
                                  </div>
                                </td>
                                <td>USA</td>
                              ...
                              <tr>
                                <td>
                                  <div className="flag">
                                    <img src="/src/assets/assets/img/flags/au.png" alt="australia" />
                                  </div>
                                </td>
                                <td>Australia</td>
                              ...
                              <tr>
                                <td>
                                  <div className="flag">
                                    <img src="/src/assets/assets/img/flags/ru.png" alt="russia" />
                                  </div>
                                </td>
                                <td>Russia</td>
                              ...
                              <tr>
                                <td>
                                  <div className="flag">
                                    <img src="/src/assets/assets/img/flags/cn.png" alt="china" />
                                  </div>
                                </td>
                                <td>China</td>
                              ...
                              <tr>
                                <td>
                                  <div className="flag">
                                    <img src="/src/assets/assets/img/flags/br.png" alt="brazil" />
                                  </div>
                                </td>
                                <td>Brasil</td>
                ...
                <div className="card">
                  <div className="card-header">
                    <div className="card-head-row card-tools-still-right">
                      ...
                      <div className="card-tools">
                        <div className="dropdown">
                          <button className="btn btn-icon btn-clean" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <div className="card-body">
                    <ol className="activity-feed">
                      ...
                      <li className="feed-item feed-item-danger">
                        ...
                        <span className="text">Created need
                          <a href="#">&quot;Volunteer Opportunity&quot;</a></span>
                      </li>
                      <li className="feed-item">
                        <time className="date" dateTime="9-17">Sep 17</time>
                        <span className="text">Attending the event
                      ...
                      <div className="card-tools">
                        <ul className="nav nav-pills nav-secondary nav-pills-no-bd nav-sm" id="pills-tab" role="tablist">
                          <li className="nav-item">
                            <a className="nav-link" id="pills-today" data-bs-toggle="pill" href="#pills-today" role="tab" aria-selected="true">Today</a>
                          </li>
                          <li className="nav-item">
                            <a className="nav-link active" id="pills-week" data-bs-toggle="pill" href="#pills-week" role="tab" aria-selected="false">Week</a>
                          </li>
                          <li className="nav-item">
                            <a className="nav-link" id="pills-month" data-bs-toggle="pill" href="#pills-month" role="tab" aria-selected="false">Month</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex">
                      ...
                      <div className="flex-1 ms-3 pt-1">
                        ...
                        <span className="text-muted">I am facing some trouble with my viewport. When i
                          start my</span>
                      </div>
                    ...
                    <div className="d-flex">
                      ...
                      <div className="flex-1 ms-3 pt-1">
                        ...
                        <span className="text-muted">Is there any update plan for RTL version near
                          future?</span>
                      </div>
                      <div className="float-end pt-1">
