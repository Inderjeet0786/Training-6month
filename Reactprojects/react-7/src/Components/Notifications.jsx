                ...
                <div className="card">
                  <div className="card-header">
                    ...
                    <div className="card-category">
                      ...
                      notifications from
                      <a className="link" href="http://bootstrap-notify.remabledesigns.com/">Bootstrap Notify</a>
                    </div>
                  </div>
                    ...
                    <div className="form">
                      <div className="form-group form-show-notify row">
                        ...
                        <div className="col-lg-4 col-md-9 col-sm-8">
                          <select className="form-select input-fixed" id="notify_placement_from">
                            <option value="top">Top</option>
                            <option value="bottom">Bottom</option>
                          </select>
                          <select className="form-select input-fixed" id="notify_placement_align">
                      ...
                      <div className="form-group form-show-notify row">
                        ...
                        <div className="col-lg-4 col-md-9 col-sm-8">
                          <select className="form-select input-fixed" id="notify_style">
